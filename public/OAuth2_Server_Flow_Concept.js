 ...
 */
{
  ...
  if (fs.existsSync(keyPath)) keys = require(keyPath).web;
  /**
...
const scopes = ['https://www.googleapis.com/auth/calendar', 'https://www.googleapis.com/auth/calendar.events', 'profile'];
